describe('Add Notes', () => {
    ...
    it('delete note & check the note in trash can', async () => {
        ...
        // await $('//*[@text="OK"]').click();
        // await expect($('//*[@resource-id="com.socialnmobile.dictapps.notepad.color.note:id/title"]')).not.toBeDisplayed();
    });
});